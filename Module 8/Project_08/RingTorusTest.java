...
public class RingTorusTest {
   ...
   */
   @Test public void setLargeRadiusTest() {
      ...
      Assert.assertEquals(newRing.setLargeRadius(0), false);
   ...
   */
   @Test public void setSmallRadiusTest() {
      ...
      Assert.assertEquals(newRing.setSmallRadius(0), false);
   ...
   */
   @Test public void equalsTest() {
      ...
      RingTorus newRing4 = new RingTorus("Ring", 8.0, 9.0);
      RingTorus newRing5 = new RingTorus("Ring", 9.0, 7.0);
      Assert.assertEquals(newRing.equals(newRing2), true);
      Assert.assertEquals(newRing.equals(newRing3), false);
      Assert.assertEquals(newRing.equals(newRing4), false);
      Assert.assertEquals(newRing.equals(newRing5), false);
      
      Assert.assertEquals(newRing.equals(90), false);
   ...
   */
   ...
   /**
      Public test method that tests the compareTo method.
   */
   @Test public void compareToTest() {
   
      RingTorus newRing = new RingTorus("Ring", 9.0, 8.0);
      RingTorus newRing2 = new RingTorus("Ring2", 8.0, 7.0);
      Assert.assertTrue(newRing.compareTo(newRing2) > 0);
      
      newRing = new RingTorus("Ring", 8.0, 7.0);
      newRing2 = new RingTorus("Ring2", 9.0, 8.0);
      Assert.assertTrue(newRing.compareTo(newRing2) < 0);
      
      newRing = new RingTorus("Ring", 8.0, 7.0);
      newRing2 = new RingTorus("Ring2", 8.0, 7.0);
      Assert.assertTrue(newRing.compareTo(newRing2) == 0);
