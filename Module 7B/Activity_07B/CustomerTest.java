...
/**
   Public class that tests the methods in the Customer class.
*/
public class CustomerTest {
   
   /**
      Public method that tests the setLocation method.
   */
   ...
   /**
      Public method that also tests the setLocation method.
   */
   ...
   /**
      Public method that tests the setBalance method.
   */
   @Test public void setBalanceTest() {
   ...
   /**
      Public method that tests the toString method.
   */
   ...
   /**
      Public method that tests the compareTo method.
   */
